...
try:
    ...
    if pln_id is None:
        ...
        object_f7c1_crop = get_data_by_plantation(pln_id)
        dict_data_plantation = object_f7c1_crop.get_one()

        object_f7c1_irrigation = F7C1Irrigation()

        dict_data_finished_execution = object_f7c1_irrigation.get_finished_execution_by_plantation(pln_id = pln_id)
