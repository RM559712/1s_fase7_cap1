...
class Irrigation:
    ...
    """
    Método responsável por verificar se uma determinada plantação deverá ter a irrigação iniciada automaticamente a partir de validações dos parâmetros preenchidos
        ...
        try:
            ...
            if type(int_sensor_type) != type(None):
                ...
                try:
                    ...
                    dict_sensor = F7C1Sensor.get_type_options(int_sensor_type)

                    match int_sensor_type:

                        case F7C1Sensor.TYPE_TEMPERATURE:
                        ...
                        case F7C1Sensor.TYPE_RADIATION:
