...
class F7C1Sensor(Database):
    ...
    def get_type_options(int_code: int = 0) -> list:
        ...
        dict_types = [
            {
                'code': F7C1Sensor.TYPE_TEMPERATURE,
                'title': 'Sensor de Temperatura do solo'
            },{
                'code': F7C1Sensor.TYPE_HUMIDITY,
                'title': 'Sensor de Umidade do solo'
            },{
                'code': F7C1Sensor.TYPE_LIGHT,
                'title': 'Sensor de luminosidade'
            },{
                'code': F7C1Sensor.TYPE_RADIATION,
                'title': 'Sensor de radiação'
            },{
                'code': F7C1Sensor.TYPE_SALINITY,
                'title': 'Sensor de salinidade do solo'
            },{
                'code': F7C1Sensor.TYPE_PH,
