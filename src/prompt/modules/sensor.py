...
from models.f7_c1_sensor import F7C1Sensor
...
def validate_exists_data():
    ...
    object_f7c1_sensor = F7C1Sensor()
    bool_exists_data = object_f7c1_sensor.validate_exists_data()
        ...
        try:
            ...
            if str_return.strip() != '':
                ...
                list_params_validate = [
                    ...
                    F7C1Sensor.get_params_to_active_data()
                ...
                dict_sensor = object_f7c1_sensor.set_where(list_params_validate).get_one()
...
def format_data_view_type(dict_data: dict = {}) -> str:
    ...
    str_return += f'{F7C1Sensor.get_type_options(dict_data['SNS_TYPE'])['title']}' if 'SNS_TYPE' in dict_data and type(dict_data['SNS_TYPE']) != None and Helper.is_int(dict_data['SNS_TYPE']) == True else 'N/I'
...
def validate_type(dict_data: dict = {}) -> int:
    ...
    list_type_options = F7C1Sensor.get_type_options()
    ...
    while True:
        ...
        try:
            ...
            if int_return.strip() != '':
                ...
                if int(int_return) not in F7C1Sensor.get_type_options_codes(): 
...
def action_list():
    ...
    object_f7c1_sensor.set_where([F7C1Sensor.get_params_to_active_data()])
    object_f7c1_sensor.set_order([{'str_column': 'SNS_ID', 'str_type_order': 'ASC'}])
    list_data = object_f7c1_sensor.get_data().get_list()
...
def action_insert():
    ...
    object_f7c1_sensor = F7C1Sensor()
    object_f7c1_sensor.insert(dict_data)

    int_sns_id = object_f7c1_sensor.get_last_id()

    # Retorno de dados após o cadastro
    object_f7c1_sensor = get_data_by_id(int_sns_id)
...
def action_update():
    ...
    object_f7c1_sensor.update(dict_data)
...
def action_delete():
    ...
    dict_data['SNS_STATUS'] = F7C1Sensor.STATUS_DELETED
