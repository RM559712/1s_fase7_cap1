...
def validate_exists_data():
    ...
    bool_exists_data = object_f7c1_irrigation.validate_exists_data()
...
def format_data_view_origin(dict_data: dict = {}) -> str:
    ...
    str_return = 'Origem: '
    str_return += f'{object_f7c1_irrigation.get_label_origin(dict_data['IRG_ORIGIN'])}' if 'IRG_ORIGIN' in dict_data and type(dict_data['IRG_ORIGIN']) != None and Helper.is_int(dict_data['IRG_ORIGIN']) == True else 'N/I'
...
def format_data_view_status_execution(dict_data: dict = {}) -> str:
    ...
    str_return += f'{object_f7c1_irrigation.get_label_status_execution(dict_data['IRG_STATUS_EXECUTION'])}' if 'IRG_STATUS_EXECUTION' in dict_data and type(dict_data['IRG_STATUS_EXECUTION']) != None and Helper.is_int(dict_data['IRG_STATUS_EXECUTION']) == True else 'N/I'
...
def action_list():
    ...
    object_f7c1_irrigation.set_select(['IRG.*', 'PLN.PLN_NAME', 'CRP.CRP_NAME'])
    object_f7c1_irrigation.set_table('F7_C1_IRRIGATION IRG')
    object_f7c1_irrigation.set_join([
    ...
    object_f7c1_irrigation.set_where([F7C1Irrigation.get_params_to_active_data()])
    object_f7c1_irrigation.set_order([{'str_column': 'IRG_ID', 'str_type_order': 'ASC'}])
    list_data = object_f7c1_irrigation.get_data().get_list()
...
def get_data_by_id(int_irg_id: int = 0) -> dict:
    ...
    object_f7c1_irrigation.set_where([
...
def action_ini():
    ...
    dict_begin_execution = object_f7c1_irrigation.begin_execution_by_plantation({'pln_id': dict_data_plantation['PLN_ID'], 'irg_origin': F7C1Irrigation.ORIGIN_MANUAL})
...
def action_end():
    ...
    dict_active_irrigation = object_f7c1_irrigation.get_active_execution_by_plantation(pln_id)
    ...
    dict_finish_execution = object_f7c1_irrigation.finish_execution_by_plantation({
