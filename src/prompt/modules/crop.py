...
from models.f7_c1_crop import F7C1Crop
...
def validate_exists_data():
    ...
    object_f7c1_crop = F7C1Crop()
    bool_exists_data = object_f7c1_crop.validate_exists_data()
        ...
        try:
            ...
            if str_return.strip() != '':
                ...
                list_params_validate = [
                    ...
                    F7C1Crop.get_params_to_active_data()
                ...
                dict_crop = object_f7c1_crop.set_where(list_params_validate).get_one()
...
def action_list():
    ...
    object_f7c1_crop.set_where([F7C1Crop.get_params_to_active_data()])
    object_f7c1_crop.set_order([{'str_column': 'CRP_ID', 'str_type_order': 'ASC'}])
    list_data = object_f7c1_crop.get_data().get_list()
...
def action_insert():
    ...
    object_f7c1_crop = F7C1Crop()
    object_f7c1_crop.insert(dict_data)

    int_crp_id = object_f7c1_crop.get_last_id()

    # Retorno de dados após o cadastro
    object_f7c1_crop = get_data_by_id(int_crp_id)
...
def action_update():
    ...
    object_f7c1_crop.update(dict_data)
...
def action_delete():
    ...
    dict_data['CRP_STATUS'] = F7C1Crop.STATUS_DELETED
