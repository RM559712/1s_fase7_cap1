...
from models.f7_c1_plantation import F7C1Plantation
from models.f7_c1_plantation_config_irrigation import F7C1PlantationConfigIrrigation
from models.f7_c1_plantation_config_location import F7C1PlantationConfigLocation
...
def validate_exists_data():
    ...
    object_f7c1_plantation = F7C1Plantation()
    bool_exists_data = object_f7c1_plantation.validate_exists_data()
        ...
        try:
            ...
            if str_return.strip() != '':
                ...
                list_params_validate = [
                    ...
                    F7C1Plantation.get_params_to_active_data()
                ...
                dict_plantation = object_f7c1_plantation.set_where(list_params_validate).get_one()
...
def action_list():
    ...
    object_f7c1_plantation.set_select(['PLN.*', 'CRP.CRP_NAME', 'PCI.*', 'PCL.*'])
    object_f7c1_plantation.set_table('F7_C1_PLANTATION PLN')
    object_f7c1_plantation.set_join([
        {'str_type_join': 'INNER JOIN', 'str_table': 'F7_C1_CROP CRP', 'str_where': 'CRP.CRP_ID = PLN.PLN_CRP_ID'},
        {'str_type_join': 'LEFT JOIN', 'str_table': 'F7_C1_PLANTATION_CONFIG_IRRIGATION PCI', 'str_where': 'PCI.PCI_PLN_ID = PLN.PLN_ID'},
        {'str_type_join': 'LEFT JOIN', 'str_table': 'F7_C1_PLANTATION_CONFIG_LOCATION PCL', 'str_where': 'PCL.PCL_PLN_ID = PLN.PLN_ID'}
    ])
    object_f7c1_plantation.set_where([F7C1Plantation.get_params_to_active_data()])
    object_f7c1_plantation.set_order([{'str_column': 'PLN.PLN_ID', 'str_type_order': 'ASC'}])
    list_data = object_f7c1_plantation.get_data().get_list()
...
def get_data_by_id(int_pln_id: int = 0) -> dict:
    ...
    object_f7c1_plantation.set_where([
...
def get_data_config_irrigation_by_id(int_pln_id: int = 0) -> dict:
    ...
    object_f7c1_plantation_config_irrigation = F7C1PlantationConfigIrrigation()

    object_f7c1_plantation_config_irrigation.set_where([

        {'str_column': 'PCI_PLN_ID', 'str_type_where': '=', 'value': int_pln_id},
        F7C1PlantationConfigIrrigation.get_params_to_active_data()

    ])

    dict_data = object_f7c1_plantation_config_irrigation.get_data().get_one()

    if type(dict_data) == type(None):
        raise Exception(f'Nenhum registro de configuração de irrigação foi localizado com o ID {int_pln_id}.')

    return object_f7c1_plantation_config_irrigation
...
def get_data_config_location_by_id(int_pln_id: int = 0) -> dict:
    ...
    object_f7c1_plantation_config_location = F7C1PlantationConfigLocation()

    object_f7c1_plantation_config_location.set_where([

        {'str_column': 'PCL_PLN_ID', 'str_type_where': '=', 'value': int_pln_id},
        F7C1PlantationConfigLocation.get_params_to_active_data()

    ])

    dict_data = object_f7c1_plantation_config_location.get_data().get_one()

    if type(dict_data) == type(None):
        raise Exception(f'Nenhum registro de configuração de localização foi localizado com o ID {int_pln_id}.')

    return object_f7c1_plantation_config_location
...
def get_data_crop_by_id(crp_id: int = 0) -> dict:
    ...
    object_f7c1_crop = ModuleCrop.get_data_by_id(crp_id)
    dict_data = object_f7c1_crop.get_one()
...
def action_insert():
    ...
    object_f7c1_plantation = F7C1Plantation()
    object_f7c1_plantation.insert(dict_data)

    int_pln_id = object_f7c1_plantation.get_last_id()
    ...
    object_f7c1_plantation_config_irrigation = F7C1PlantationConfigIrrigation()
    object_f7c1_plantation_config_irrigation.insert(dict_data_config_irrigation)
    ...
    object_f7c1_plantation_config_location = F7C1PlantationConfigLocation()
    object_f7c1_plantation_config_location.insert(dict_data_config_location)

    # Retorno de dados após o cadastro
    object_f7c1_plantation = get_data_by_id(int_pln_id)
...
def action_update():
    ...
    object_f7c1_plantation.update(dict_data)

    # -------------------------------------------------------------------
    # Processo de atualização dos parâmetros de configuração de irrigação
    # -------------------------------------------------------------------

    object_f7c1_plantation_config_irrigation = get_data_config_irrigation_by_id(int_pln_id)
    dict_data_config_irrigation = object_f7c1_plantation_config_irrigation.get_one()
    ...
    object_f7c1_plantation_config_irrigation.update(dict_data_config_irrigation)

    # -----------------------------------------------------
    # Processo de atualização dos parâmetros de localização
    # -----------------------------------------------------

    object_f7c1_plantation_config_location = get_data_config_location_by_id(int_pln_id)
    dict_data_config_location = object_f7c1_plantation_config_location.get_one()
    ...
    if type(dict_data_config_location) != type(None):
        object_f7c1_plantation_config_location.update(dict_data_config_location)
...
def action_delete():
    ...
    dict_data['PLN_STATUS'] = F7C1Plantation.STATUS_DELETED
    ...
    dict_data_config_irrigation['PCI_STATUS'] = F7C1PlantationConfigIrrigation.STATUS_DELETED
    ...
    dict_data_config_location['PCL_STATUS'] = F7C1PlantationConfigLocation.STATUS_DELETED
